...
extern bool is_ArpTableEnabled();

extern bool Arp_OutputPolicy_Drop(bool p_bDrop);
extern bool Arp_commands(char * p_sCmd);

extern int Parse_strarray(char * str, char ** strarr);
